...
const ExcelIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M3 3h18v18H3V3z" fill="#217346"/><path d="M3 3h18v18H3V3z" fill="#217346"/><path d="M6 6h12v12H6V6z" fill="white"/><path d="M8 8l3 4-3 4h2l2-2.67L14 16h2l-3-4 3-4h-2l-2 2.67L10 8H8z" fill="#217346"/></svg>;
...
const OnboardingPage: React.FC<OnboardingPageProps> = ({
  organizationName, orgId, onImport, onZohoConnect,
  onStartFresh, onGoogleSheetsImport, onExcelImport, onPosConnected
}) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 text-center p-4">
      ...
      <div className="mt-10 flex flex-col items-center gap-8 w-full max-w-2xl">
        ...
        >
          <PlusCircleIcon />
          <h2 className="mt-4 text-2xl font-semibold">Start from Scratch</h2>
        ...
        <div className="w-full bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
          ...
          <div className="space-y-3">
            {/* Zoho Books — opens setup modal */}
            <button
              onClick={() => setShowZohoSetup(true)}
              disabled={isImporting}
              className="w-full flex items-center justify-between p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg hover:bg-orange-100 dark:hover:bg-orange-900/30 transition-colors disabled:opacity-50"
            >
              <div className="flex items-center gap-3">
                <ZohoIcon />
                <div className="text-left">
                  <h4 className="font-medium text-gray-900 dark:text-gray-100">Import from Zoho Books</h4>
                  <p className="text-xs text-gray-500 dark:text-gray-400">Connect your Zoho Books account and sync inventory</p>
                </div>
              </div>
              <span className="text-xs text-orange-600 dark:text-orange-400 font-medium">Connect →</span>
            </button>
