                    ...
                    <ol className="list-decimal list-inside space-y-2 mb-4">
                        ...
                        <li>Fill in the details:
                            <ul className="list-disc list-inside ml-4 mt-1 space-y-1">
                                ...
                                <li><strong>Homepage URL:</strong> Your frontend domain (e.g. https://your-app.web.app)</li>
                                <li><strong>Redirect URI:</strong> Your backend domain + /callback/zoho (e.g. https://your-backend.up.railway.app/callback/zoho)</li>
                            </ul>
                        </li>
